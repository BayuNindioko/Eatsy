...
class AuthController extends Controller
{
    ...
    {
        $responseRes = Http::get('https://lamaisonetc.my.id/api/tables/' . $id . '/reservations');
        ...
        $response = Http::get('https://lamaisonetc.my.id/api/tables/' . $id . '/reservations/register');
        $data = $response->json();
    ...
    public function process($id, Request $request)
    {
        ...
        $response = Http::post('https://lamaisonetc.my.id/api/tables/' . $id . '/reservations', $request->all());
    ...
    public function login_request($id, Request $request)
    {
        ...
        $response = Http::post('https://lamaisonetc.my.id/api/tables/reservations/' . $id . '/login', $request->all());
    ...
    public function welcome_pin()
    {
        ...
        $responseRes = Http::get('https://lamaisonetc.my.id/api/tables/' . $tableIdInSession . '/reservations');
